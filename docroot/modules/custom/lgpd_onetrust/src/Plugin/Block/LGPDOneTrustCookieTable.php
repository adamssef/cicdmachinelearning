 ...
 *
 * @Block(
 *   id = "lgpd_onetrust_header",
 *   admin_label = @Translation(" LGPD One Trust Cookie Table"),
 *   category = @Translation("LGPD Onetrust"),
 * )
 */
class LGPDOneTrustCookieTable extends BlockBase implements ContainerFactoryPluginInterface {
